...
class StealingAttack:
    def __init__(
        ...
        self.partial_graph_path = self.args["partial_graph_path"]
        self.ratio = self.args["attack_partial_graph_ratio"]
        self.operator = self.args["attack_operator"]
        self.metric_type = self.args["attack_metric_type"]
        self.attack()
    ...
    def attack(self):
        ...
        with open("result/attack_results.csv", "a", newline="") as csvfile:
            ...
            writer.writerow(
                [
                    self.dataset,
                    self.args["removal_mode"],
                    self.args["ratio_removes"],
                    "attack3_metrics_%s" % (self.operator),
                    epochs,
                    test_acc,
                    test_precision,
