...
for a in cora citeseer
do

    for b in partial_feature
    do
        ...
        do
            ...
            do
                ...
                do 
                    ...
                    for f in 20230202 20230203 20230204 20230205
                    do
                        ...
                        python main.py \
                            ...
                            --unlearn_ratio $d \
                            --iteration 0 \
                            --file_name unlearning_attack_materials \
                            --unlearn_feature_partial_ratio $e \
                            --seeds $f \
                            --scale 0
